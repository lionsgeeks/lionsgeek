...
export const FourthSection = () => {
    ...
    let cards = [
        {
            icon: (
                <svg
                    ...
                    style={{ stroke: darkMode ? 'var(--color-alpha)' : '#ffffff', fill: darkMode ? 'var(--color-alpha)' : '#ffffff' }}
                >
                    <path
                        fillRule="evenodd"
    ...
    return (
        <div className="flex flex-col gap-8 bg-gray-50 px-7 py-16 lg:px-16" style={{ backgroundColor: darkMode ? 'var(--color-beta)' : '#ffffff' }}>
