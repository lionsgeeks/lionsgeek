...
<body>
    ...
    <div class="content">
        <h3>Invitation to {{ $eventName }}</h3>
        <h5>Name: {{ $booking->name }}</h5>
        <p>
            Welcome to LionsGeek! This email serves as your ticket to the event — please keep it safe and bring it with you (either digitally or printed) to gain entry. We look forward to seeing you.
        </p>
        <p style="margin: 8px 0;"><strong>Email:</strong> {{ $booking->email }}</p>
        <p style="margin: 8px 0;"><strong>Phone:</strong> {{ $booking->phone }}</p>
        <p style="margin: 8px 0;"><strong>Date:</strong> {{ \Carbon\Carbon::parse($eventDate)->format('l, F j, Y g:i A') }}</p>
        <p style="margin: 8px 0;"><strong>Description:</strong> {{ $eventDescription }}</p>

        <div class="qr-section">
            <h4>For Event Organizers</h4>
            <img src="data:{{ $qrMime ?? 'image/jpeg' }};base64,{{ $qrCode }}" alt="QR Code">
            <p>Scan this QR code at the entrance for check-in.</p>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <div class="map">
            <a href="https://www.google.com/maps/place/LionsGeek/@33.6036273,-7.5357722,733m/data=!3m1!1e3!4m6!3m5!1s0xda7cdb2f812837f:0xbbcfc74fbc11b2d9!8m2!3d33.6037882!4d-7.5338517!16s%2Fg%2F11jy9l0d4m?authuser=0&entry=ttu">
