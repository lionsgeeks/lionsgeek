            ...
            >
              ...
              />
                ...
                {formationMenu && (
                  ...
                  >
                    <div className={`py-2 bg-white rounded-md lg:min-w-[15vw] min-w-[40vw] shadow-lg dark-mode:bg-gray-700 flex flex-col gap-2 ${darkMode && "bg-[#0f0f0f] "}`}>
                      <Link
                        id="codingLink"
                        to={"/coding"}
              ...
              <Link
                to={"/coworking"}
                onClick={() => setIsOpen(false)}
                className={`${darkMode ? "text-white" :"#0f0f0f"} px-2 py-2 text-sm relative after:absolute after:border-b-[2px]  after:bottom-[-13px] after:left-0 after:w-0 hover:after:w-[100%] after:transition-all after:duration-[0.35s]  ${
                  location.pathname == "/coworking"
                    ? "font-medium  after:border-alpha after:w-[100%]"
                    : "after:border-gray-300"
                }`}
              >
...
<button
  ...
  className="p-2 transition-colors duration-200 rounded-full focus:outline-none"
>
{darkMode ? (
  <svg
  xmlns="http://www.w3.org/2000/svg"
