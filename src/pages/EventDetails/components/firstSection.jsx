        ...
        <>
            {
                check.map((element, index) =>
                    <>
                        <div className=' h-fit lg:p-16 p-7  '>
                            <div className='lg:h-[13vh] first w-full gap-5 rounded-l-lg flex '>
                                {/* date */}
                                <div className='w-[7%] hidden lg:flex lg:flex-col  '> <div className='bg-alpha rounded-t-lg h-[40%] flex items-center justify-center font-bold text-white text-lg '>JUIN</div>
                                ...
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <div className='flex gap-3 text-gray-400'>
                                        ...
                                        <p> 4eme étage, Ain Sebaa Center</p>
                                    </div>
                                </div>
                            </div>
                            {/* <div className="p-2">
                            ...
                            <div className='lg:flex lg:flex-row flex-col  gap-10 h-[100%] first '>
                                <div className="   lg:w-[70%] py-5 flex flex-col gap-5 ">
                                    <img className="lg:h-[55vh] w-[100%] rounded-lg " src={element.image} alt="" />
