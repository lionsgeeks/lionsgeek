...
export const FourthSection = () => {
  ...
  return (
    <div className="bg-gray-50 p-16 flex flex-col gap-8">
      <div className="w-full text-center pb-10">
        <h1 className="text-xl"><TransText ar="ما يمكن توقعه" fr="À quoi s'attendre" en="What to Expect" /></h1>
        <h1 className="text-5xl font-bold"><TransText fr="Pendant le voyage" ar="أثناء الرحلة" en="During the journey" /></h1>
      </div>
