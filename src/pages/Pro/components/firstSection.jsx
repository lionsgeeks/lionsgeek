            ...
            <>
                <div className="w-full lg:px-16">
                    ...
                    <div className="flex flex-col gap-4 w-full items-center py-8  self-center ">
                        <h1 className="lg:text-5xl text-3xl font-bold">{t('main.lionsgeekpro.firstsection.first-title')}</h1>
                    ...
                    <div className="w-full  px-3  flex justify-between flex-wrap gap-3">

                        {
                            services.map((ele, idx) =>
                                <>
                                    <div className={`lg:w-[48%] w-full relative border-2 py-5  ${selectedLanguage === "ar" && "text-end"}  overflow-hidden rounded-xl`}>
                                        <img className='absolute top-0 w-full h-full  object-cover -z-20 opacity-90' src={ele.photo} alt="" />
                                        ...
                                        <div className="w-full flex items-center justify-between p-8">
                                            ...
                                            <h1 className='text-alpha text-4xl shadow font-bold'>0{ele.id}</h1>
                                        </div>

                                        <div className="py-5 px-8">
                                            <h1 className='text-3xl text-white font-bold'>{t(ele.header)}</h1>
                                        ...
                                        <div className="px-8 py-2 text-white">

                                            {
                                                ele.descriptions.map((e, i) =>
                                                    ...
                                                    <div className={`text-white flex   items-center gap-x-3 mt-2   ${selectedLanguage === "ar" && " flex-row-reverse"}`}>
                    ...
                    <div className="text-center py-5 mt-5">
                        <Link className='bg-alpha py-3 px-7 rounded-lg' to={"/contact-us"}><TransText en='Contact Us' fr='Contactez-nous' ar='اتصل بنا' /></Link>
                    </div>

                    <div className="py-3 mt-3 text-center ">
                        <h1 className='lg:text-5xl text-3xl font-bold'><TransText en="Those Who Trust in Us" fr="Ceux Qui Nous Font Confiance" ar="من يثقون بنا" /></h1>
                        <p className='lg:text-l lg:px-0 px-4 py-3 mt-2 font-normal'><TransText en="We are honored to work alongside organizations that share our values, striving for success together." fr="Nous sommes honorés de collaborer avec des organisations partageant nos valeurs, œuvrant ensemble vers la réussite." ar="نفتخر بالعمل جنباً إلى جنب مع المؤسسات التي تشاركنا قيمنا، ساعين معاً نحو النجاح." /></p>
                    </div>
