...
export const SecondSectionCoworking = () => {
    ...
    const recreation = useRef(null);
    const network = useRef(null);
    const security = useRef(null);


    useEffect(() => {
        gsap.fromTo(wifi.current,
            { x: "-100%", y: "-40%", opacity: "0" },
            {
                x: "0%",
                y : "0%",
                duration: 0.5,
        ...
        gsap.fromTo(podcast.current,
            { x: "100%", y: "-40%", opacity: "0" },
            {
                ...
                ease: "none",
                scrollTrigger: {
                    trigger: podcast.current,
                }
            }
        );
        gsap.fromTo(recreation.current,
            { x: "-100%", y: "40%", opacity: "0" },
            {
                x: "0%",
                y: "0%",
    ...
    return (
        <div className='p-5 lg:px-16 py-20 flex flex-col gap-5 overflow-hidden'>
            ...
            <div className='w-full flex flex-wrap justify-evenly gap-y-7 gap-x-1  lg:py-5'>
                <div ref={wifi} className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                ...
                <div ref={photo} className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                ...
                <div ref={podcast} className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20 fill-alpha ">
                ...
                <div ref={recreation}  className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20 fill-alpha ">
                ...
                <div ref={network} className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                    <div className='size-20 '>
                ...
                <div ref={security} className='w-5/6 md:w-[45%] lg:w-1/4 px-5 py-10 flex flex-col text-center items-center gap-2  shadow-lg rounded-xl hover:scale-105 duration-300 '>
                    <div className='size-20 '>
