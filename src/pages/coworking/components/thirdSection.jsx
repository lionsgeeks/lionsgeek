...
export const ThirdSectionCoworking = () => {
    ...
    return (
        <div className='p-5 lg:px-16 py-10 flex flex-col gap-5 text-center'>
            <h1 className='text-lg lg:text-xl '>{t('main.coworking.section3.title.first')}</h1>
            <h1 className='text-2xl lg:text-5xl font-bold'>{t('main.coworking.section3.title.second')}</h1>
