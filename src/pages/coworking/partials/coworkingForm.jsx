...
const ApplicationForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.post(URL + 'cowork', newForm).then(() => {
            setFormInfo({
                full_name: '',
                email: '',
                phone: '',
    ...
    const domainOptions = [
        { label: <TransText fr="Audiovisuel" ar="سمعي بصري" en="Audiovisual" />, value: 'audio-visuel' },
        { label: <TransText fr="Création de contenu digital" ar="إنشاء محتوى رقمي" en="Digital Content Creation" />, value: 'content-creation' },
        { label: <TransText fr="Photographie" ar="التصوير" en="Photography" />, value: 'photography' },
        { label: <TransText fr="Création de site Web" ar="إنشاء مواقع إلكترونية" en="Web Creation" />, value: 'web-creation' },
        { label: <TransText fr="Application web" ar="تطبيق الويب" en="Web Application" />, value: 'web-app' },
        { label: <TransText ar="أخرى" en="Other" fr='Autre' />, value: 'other' },
    ];


    const sourceOptions = [
        { label: <TransText fr="J'ai vu une annonce sur les réseaux sociaux" ar="رأيت إعلانا على الشبكات الاجتماعية" en="I saw an ad on social media" />, value: 'social-media' },
        { label: <TransText fr="J'ai reçu une invitation par email" ar="استلمت دعوة عبر البريد الإلكتروني" en="I received an invitation via email" />, value: 'email-invitation' },
        { label: <TransText fr="Quelqu'un m'en a parlé personnellement" ar="أخبرني شخص ما عن ذلك شخصياً" en="Someone told me about it personally" />, value: 'personal-recommendation' },
        { label: <TransText fr="J'ai lu un article dans un magazine ou un journal" ar="قرأت مقالة في مجلة أو جريدة" en="I read an article in a magazine or newspaper" />, value: 'magazine-article' },
        { label: <TransText fr="J'ai vu une affiche ou une publicité dans la rue" ar="رأيت إعلاما أو إعلانا في الشارع" en="I saw a poster or advertisement on the street" />, value: 'street-advertisement' },
        { label: <TransText fr="J'ai trouvé l'information en effectuant une recherche en ligne" ar="وجدت المعلومات عند البحث عبر الإنترنت" en="I found the information by searching online" />, value: 'online-search' },
        { label: <TransText ar="أخرى" en="Other" fr='Autre' />, value: 'other' },
    ];


    const workspaceOptions = [
        { label: <TransText fr="1 seul post de travail" ar="1 محطة عمل واحدة" en="Single Workstation" />, value: 'single-workstation' },
        { label: <TransText fr="Un espace de travail pour 2/3 personnes" ar="مساحة عمل لـ 2/3 أشخاص" en="Workspace for 2/3 People" />, value: 'workspace2_3' },
        { label: <TransText fr="Studio de tournage / Podcast" ar="استوديو تصوير / بودكاست" en="Filming Studio / Podcast" />, value: 'studio' },
        { label: <TransText fr="Salle de réunion" ar="قاعة الإجتماعات" en="Meeting Room" />, value: 'meeting-room' },
        { label: <TransText ar="أخرى" en="Other" fr='Autre' />, value: 'other' },
    ];
    ...
    return (
        <div className='px-4 pt-24 lg:px-16 lg:pt-28 overflow-hidden' dir={selectedLanguage === "ar" ? 'rtl' : 'ltr'}>
            <form onSubmit={handleSubmit} className="p-6 bg-gray-50/50 rounded-lg shadow-md mb-4">
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="proj_name">
                        <TransText
                            en='Project Name'
                            fr='Nom du Project'
                            ar='اسم المشروع'
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="proj_desc">
                        <TransText
                    ...
                    {domainOptions.map((option) => (
                        <label className="inline-flex items-center m-2" key={option.value}>
                            <input
                                ...
                                onChange={(e) => { handleCheckboxChange(e, setDomain) }}
                ...
                <div className="mb-4">
                    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="proj_plan">
                        <TransText
                    ...
                    {sourceOptions.map((option) => (
                        <label className="inline-flex items-center m-2" key={option.value}>
                            <input
                                ...
                                onChange={(e) => { handleCheckboxChange(e, setReasons) }}
                                className="form-checkbox"
                            />
                            <span className="m-2">{option.label}</span>
                        </label>
