    ...
    translation: {
      ...
      main: {
          ...
          section2: {
            ...
            cards: {
              wifi: {
                ...
                description:
                  "Our workspace offers a cutting-edge high-speed internet service designed to meet the demanding needs of businesses and individuals in today's fast-paced degital landscape",
              },
              Photography: {
                title: "Photography Studio",
                description:
                  "photography studio, perfect for capturing high-quality images of yourself or your products, enhancing your branding and marketing efforts.",
              },
              Podcast: {
                title: "Podcast Studio",
                description:
                  "Our coworking space features a dedicated podcast studio, providing a quiet, well-equipped environment for recording high-quality audio, ensuring your podcast sounds professional and polished.",
              },
              Recreation: {
                title: "Recreation Area",
                description:
                  "Our coworking space includes a vibrant recreation area, providing a relaxing environment for unwinding or socializing, enhancing work-life balance and fostering a positive community atmosphere.",
              },
              Networking: {
                title: "Networking",
                description:
                  "Our coworking space offers unparalleled networking opportunities, connecting you with professionals and collaborators, fostering innovation, idea exchange, and growth in a dynamic environment.",
              },
              Security: {
                title: "High Security",
                description:
                  "Our coworking space ensures top-notch security, prioritizing your safety and well-being, allowing you to work confidently and focus on your tasks without worry in a secure environment.",
              },
            },
          },
          section3: {
        ...
        lionsgeekpro: {
          header: {
            title:
              "Feeling overwhelmed? We offer a range of services to streamline your operations, boost efficiency, and help you achieve your goals.",
          },
          firstsection: {
            ...
            desc1:
              "Creation and redesign of websites to improve user experience and communication of NGO missions",
            title3: "Maintenance and Technical Support",
            desc3:
              "Ongoing support and regular updates to ensure the smooth functioning of websites",
          ...
          Secondsection: {
            ...
            title3: "Viral Videos",
            desc3:
              "Production of engaging videos designed to be shared widely on social networks",
            title4: "Podcasts",
            desc4:
              " Create podcasts to discuss relevant topics and engage a wide audience",
            title5: "Event Coverage",
            desc5: " Professional video and photography to document events",
            title6: "Live Social Media Broadcasts",
            desc6:
              " Organize live broadcasts for real-time events and interactive sessions",
          },
          section3: {
            title1: "Digital Marketing",
            title2: "User Generated Content (UGC)",
            desc1:
              "Training on creating and using user-generated content to increase community engagement",
            title3: "Social Media Management",
            desc3:
              "Develop customized strategies and manage content to optimize online presence",
            title4: "SEO and Content Marketing",
            desc4:
              "SEO audits and content strategies to improve search engine visibility",
          ...
          section4: {
            ...
            desc1:
              "Plan and manage hackathons to stimulate innovation and find technological solutions to NGO challenges.",
            title3: "Workshops and Trainings",
            desc3:
              "Training sessions to improve the technical skills of NGO volunteers and members",
          },
        },
        Events: {
  ...
  fr: {
    translation: {
          ...
          section2: {
            ...
            cards: {
              wifi: {
                ...
                description:
                  "Notre espace de travail offre un service Internet haut débit de pointe conçu pour répondre aux besoins exigeants des entreprises et des particuliers dans le paysage numérique rapide d'aujourd'hui.",
              },
              Photography: {
                title: "Studio de Photographie",
                description:
                  "Studio de photographie, parfait pour capturer des images de haute qualité de vous-même ou de vos produits, améliorant ainsi vos efforts de branding et de marketing.",
              },
              Podcast: {
                title: "Studio de Podcast",
                description:
                  "Notre espace de coworking dispose d'un studio de podcast dédié, offrant un environnement calme et bien équipé pour enregistrer un audio de haute qualité, garantissant que votre podcast sonne professionnel et soigné.",
              },
              Recreation: {
                title: "Espace de Récréation",
                description:
                  "Notre espace de coworking comprend une zone de récréation dynamique, offrant un environnement relaxant pour se détendre ou socialiser, améliorant l'équilibre travail-vie et favorisant une atmosphère communautaire positive.",
              },
              Networking: {
                title: "Réseautage",
                description:
                  "Notre espace de coworking offre des opportunités de réseautage inégalées, vous connectant avec des professionnels et des collaborateurs, favorisant l'innovation, l'échange d'idées et la croissance dans un environnement dynamique.",
              },
              Security: {
                title: "Haute Sécurité",
                description:
                  "Notre espace de coworking garantit une sécurité de premier ordre, priorisant votre sécurité et votre bien-être, vous permettant de travailler en toute confiance et de vous concentrer sur vos tâches sans souci dans un environnement sécurisé.",
              },
            },
          },
          section3: {
      ...
      lionsgeekpro: {
        header: {
          title:
            "Vous vous sentez submergé ? Nous proposons une gamme de services pour rationaliser vos opérations, améliorer le fficacité et vous aider à atteindre vos objectifs",
        },
        firstsection: {
          ...
          desc1:
            "Création et refonte de sites Web pour améliorer l'expérience utilisateur et la communication des missions des ONG",
          title3: "Maintenance et Support Technique",
          desc3:
            "Support continu et mises à jour régulières pour garantir le bon fonctionnement des sites Web",
          title4: "Développement d'Applications Web et Mobiles",
          desc4:
            "Solutions sur mesure pour la gestion des bénévoles et des donateurs",
        },
        Secondsection: {
          title1: "Production Audiovisuelle",
          title2: "Films Institutionnels",
          desc1:
            "Conception de films pour présenter les missions et les impacts des ONG",
          title3: "Vidéos Virales",
          desc3:
            "Production de vidéos engageantes destinées à être partagées massivement sur les réseaux sociaux",
          title4: "Podcasts",
          desc4:
            " Création de podcasts pour discuter de sujets pertinents et engager un large public",
          title5: "Couverture d’Événements",
          desc5:
            " Captation vidéo et photographie professionnelle pour documenter les événements.",
          title6: "Live sur les Réseaux Sociaux",
          desc6:
            "  Organisation de diffusions en direct pour des événements en temps réel et des sessions interactivesc",
        },
        section3: {
          title1: "Marketing Digital",
          title2: "Création de Contenu Utilisateur (UGC)",
          desc1:
            "Formation à la création et à l'utilisation de contenu généré par les utilisateurs pour augmenter l'engagement communautaire.",
          title3: "Gestion des Réseaux Sociaux",
          desc3:
            "Développement de stratégies sur mesure et gestion de contenu pour optimiser la présence en ligne",
          title4: "SEO et Marketing de Contenu",
          desc4:
            " Audits SEO et stratégies de contenu pour améliorer la visibilité sur les moteurs de recherche.",
          title5: "Publicité en Ligne",
          desc5:
            " Création, gestion et optimisation de campagnes publicitaires en ligne",
        },
        section3: {
          title1: "Marketing Digital",
          title2: "Création de Contenu Utilisateur (UGC)",
        ...
        section4: {
          ...
          desc1:
            "Planification et gestion de hackathons pour stimuler l'innovation et trouver des solutions technologiques aux défis des ONG",
          title3: "Ateliers et Formations",
          desc3:
            "Sessions de formation pour améliorer les compétences techniques des bénévoles et des membres des ONG.",
        },
      },
      Events: {
  ...
  ar: {
    translation: {
      ...
      main: {
        coworking: {
          section1: {
            ...
            description:
              "مرحبا بكم في مساحة العمل المشترك المجانية الخاصة بنا، ملاذ هادئ وآمن مصمم لإلهام الإنتاجية والإبداع. هنا، يمكنك العمل على أفكارك والدراسة والتواصل مع أشخاص متشابهين في التفكير. سواء كنت تعمل لحسابك الخاص أو طالبًا أو رائد أعمال، فإن مساحتنا توفر البيئة المثالية للتركيز والتعاون. انضم إلينا واختبر مجتمعًا داعمًا حيث يزدهر الابتكار والتشبيك.",
            button: "انضم إلينا",
          },
          section2: {
            titleSection: {
            ...
            cards: {
              wifi: {
                ...
                description:
                  "توفر مساحة العمل الخاصة بنا خدمة إنترنت عالية السرعة مصممة لتلبية الاحتياجات المتطلبة للشركات والأفراد في المشهد الرقمي السريع الوتيرة اليوم.",
              },
              Photography: {
                title: "استوديو تصوير",
                description:
                  "استوديو تصوير مثالي لالتقاط صور عالية الجودة لنفسك أو لمنتجاتك، مما يعزز جهود العلامة التجارية والتسويق الخاصة بك.",
              },
              Podcast: {
                title: "استوديو بودكاست",
                description:
                  "تتميز مساحة العمل المشترك لدينا باستوديو بودكاست مخصص، يوفر بيئة هادئة ومجهزة تجهيزًا جيدًا لتسجيل صوت عالي الجودة، مما يضمن صوتًا احترافيًا مصقولًا لبودكاست الخاص بك.",
              },
              Recreation: {
                title: "منطقة الترفيه",
                description:
                  "تتضمن مساحة العمل المشترك الخاصة بنا منطقة ترفيه نابضة بالحياة، توفر بيئة مريحة للاسترخاء أو التواصل الاجتماعي، وتعزيز التوازن بين العمل والحياة الشخصية وتعزيز أجواء مجتمعية إيجابية.",
              },
              Networking: {
                title: "التواصل",
                description:
                  "تقدم مساحة العمل المشترك الخاصة بنا فرصًا لا مثيل لها للتنظيم الشبكي، حيث تتيح لك التواصل مع المهنيين والمتعاونين، وتعزز الابتكار وتبادل الأفكار والنمو في بيئة ديناميكية.",
              },
              Security: {
                title: "أمن عالي",
                description:
                  "تضمن مساحة العمل المشترك الخاصة بنا أعلى مستوى من الأمان، مع إعطاء الأولوية لسلامتك ورفاهيتك، مما يتيح لك العمل بثقة والتركيز على مهامك دون قلق في بيئة آمنة.",
              },
            },
          },
          section3: {
      ...
      lionsgeekpro: {
        header: {
          title:
            "تشعر بالإرهاق؟ نحن نقدم مجموعة من الخدمات لتبسيط عملياتك وتعزيز الكفاءة ومساعدتك على تحقيق أهدافك.",
        },
        firstsection: {
          "first-title": "خدماتنا",
          title1: "تطوير الويب",
          ...
          desc1:
            "إنشاء وإعادة تصميم مواقع الويب لتحسين تجربة المستخدم والتواصل برسائل المنظمات غير الحكومية",
        ...
        Secondsection: {
          ...
          desc3:
            "إنتاج فيديوهات جذابة مخصصة للمشاركة على نطاق واسع على مواقع التواصل الاجتماعي",
          title4: "بودكاست",
        ...
        section3: {
          ...
          desc1:
            "تدريب على إنشاء واستخدام محتوى من إنشاء المستخدم لزيادة مشاركة المجتمع.",
          title3: "إدارة وسائل التواصل الاجتماعي",
          desc3:
            "تطوير استراتيجيات مخصصة وإدارة المحتوى لتحسين التواجد عبر الإنترنت",
          title4: "SEO وتسويق المحتوى:",
          desc4:
            "عمليات تدقيق SEO واستراتيجيات المحتوى لتحسين الرؤية على محركات البحث.",
        ...
        section4: {
          ...
          desc1:
            "التخطيط وإدارة الهاكاثون لتحفيز الابتكار وإيجاد حلول تقنية لتحديات المنظمات غير الحكومية.",
          title3: "الورش والدورات التدريبية",
          desc3:
            "جلسات تدريبية لتحسين المهارات التقنية للمتطوعين وأعضاء المنظمات غير الحكومية",
        },
      },
      Events: {
